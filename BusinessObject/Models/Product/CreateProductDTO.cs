...
public class CreateProductDTO
{
	...
	[Required, StringLength(40, ErrorMessage = "Độ dài tên sản phẩm không quá 40 kí tự.")]
	public required string ProductName { get; set; }
	[Required, StringLength(20, ErrorMessage = "Độ dài mô tả cân nặng không quá 20 kí tự.")]
